...
public class ProfileRequestDto {
  ...
  @Size(
      min = 5,
      max = 30,
      message = "The length of the name should be between 5 and 100 characters")
  private String name;
  ...
  @Size(
      min = 5,
      max = 50,
      message = "The length of the street should be between 5 and 50 characters")
  ...
  @Size(
      min = 2,
      max = 30,
      message = "The length of the state should be between 2 and 30 characters")
